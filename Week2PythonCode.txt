'''
Author: Prof. Bruce Land
Modified by: Shreyas Patil, Parth Sarthi Sharma
...
sg.SetOptions(background_color='#9FB8AD',
       ...
       input_elements_background_color='#9FB8AD',
       progress_meter_color = ('green', 'blue'),
       button_color=('white','#475841'),
       )

# Create the Window
window = sg.Window('Dino Game Controller', layout, location=(0,0), 
